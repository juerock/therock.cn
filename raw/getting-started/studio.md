...
<video :controls="true" :loop="true" src="https://res.cloudinary.com/nuxt/video/upload/v1767647099/studio/studio-demo_eiofld.mp4">
...
Create, edit, rename, and delete content files in the <span className="s2">
